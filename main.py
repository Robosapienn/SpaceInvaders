...
class Game:
    def __init__(self):
        ...
        self.live_surf = pygame.transform.scale(self.live_surf, (36, 24))
        self.live_x_start_pos = screen_width - (self.live_surf.get_size()[0] * 3 + 30)
        self.score = 0
        self.font = pygame.font.Font('font/retro.ttf', 20)
        ...
        for row_index, row in enumerate(self.shape):
            for col_index, col in enumerate(row):
                if col == 'x':
                    ...
                    block = obstacle.Block(self.block_size, (27, 255, 0), x, y)
